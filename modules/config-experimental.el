...
;; (defvar crux-mode-map
;;   (let ((map (make-sparse-keymap)))
;;     (define-key map (kbd "C-c o") 'crux-open-with)
;;     (define-key map (kbd "C-c g") 'core/google)
;;     (define-key map (kbd "C-c G") 'core/github)
;;     (define-key map (kbd "C-c y") 'core/youtube)
;;     (define-key map (kbd "C-c U") 'core/duckduckgo)
...
;;     (define-key map (kbd "C-c I") 'crux-find-core/init-file)
...
;;          ["Find init file" crux-find-core/init-file]
;;          ["Find custom file" crux-find-core/custom-file]
