...
(set-face-attribute 'default nil
 ...
 (setq-default
   ...
   visible-bell nil)                   ; don't blink
    ...
    #+END_SRC
*** better-defaults
[[https://github.com/technomancy/better-defaults/tree/0937ac9a813632c48d114cf959768cda9676db3a][Link]]
Fixes weird emacs quirks and poor defaults.
 #+BEGIN_SRC emacs-lisp
...
(setq mouse-autoselect-window t
 ...
 #+END_SRC
*** all-the-icons
    [[https://github.com/domtronn/all-the-icons.el][Link]]
...
icons the same way you would normal text.
...
(use-package all-the-icons)
 #+END_SRC
*** all-the-icons-ivy
[[https://github.com/asok/all-the-icons-ivy][Link]]
...
*** hlinum
[[https://github.com/tom-tan/hlinum-mode][Link]]
linum-mode highlights the current line number
 #+BEGIN_SRC emacs-lisp
 ...
 #+END_SRC
*** doom-themes
[[https://github.com/hlissner/emacs-doom-themes][Link]]
...
(if (eq system-type 'darwin)
 ...
 #+END_SRC
*** doom-modeline
  [[https://github.com/seagle0128/doom-modeline/tree/6293c63924732f4b5592a8ca580192df2504c159][Link]]
...
(dotimes (n 10)
  ...
  #+END_SRC
*** recentf
[[https://www.emacswiki.org/emacs/RecentFiles][Link]]
...
*** vlf
[[https://github.com/m00natic/vlfi][Link]]
This vlf command visits part of large file without loading it entirely.  The buffer uses VLF mode, which provides several commands for moving around, searching, comparing and editing selected part of file. To have it offered when opening large files
 #+BEGIN_SRC emacs-lisp
(use-package vlf
:commands (vlf))
 #+END_SRC
*** scratch
[[https://github.com/ieure/scratch-el][Link]]
Scratch is an extension to Emacs that enables one to create scratch buffers that are in the same mode as the current buffer.
  #+BEGIN_SRC emacs-lisp
(use-package scratch
:commands
(scratch))
  #+END_SRC
*** persistent-scratch
[[https://github.com/Fanael/persistent-scratch/tree/71371a7ce9846754276350fd577dc7543eb52878][Link]]
...
#+END_SRC
*** unkillable-scratch
[[https://github.com/EricCrosson/unkillable-scratch/tree/b24c2a760529833f230c14cb02ff6e7ec92288ab][Link]]
...
(use-package unkillable-scratch
  ...
  #+END_SRC
*** desktop-environment
[[https://github.com/DamienCassou/desktop-environment][Link]]
With desktop-environment, you can control the brightness and volume
as well as take screenshots and lock your screen.
 #+BEGIN_SRC emacs-lisp
(use-package desktop-environment
 ...
 #+END_SRC
*** visual-fill-column
[[https://github.com/joostkremers/visual-fill-column/tree/772d4b25ba19f57409cd03524be0f5bfdc2e8da1][Link]]
Instead of wrapping lines at the window edge, which
...
(use-package visual-fill-column
 ...
 #+END_SRC
*** company
[[https://github.com/company-mode/company-mode][Link]]
...
*** historian
[[https://github.com/PythonNut/historian.el/tree/64f4ef8cd4e417dfa090138a2d4ea1e72fd4456a][Link]]
...
:commands (historian))
 ...
 #+END_SRC
*** ivy
[[https://github.com/abo-abo/swiper][Link]]
...
:commands (ivy-historian))
 #+END_SRC
*** ivy-rich
[[https://github.com/Yevgnen/ivy-rich/tree/f6bfa293c6df0b43cc411876b665816ec3f03d08][Link]]
...
(setq ivy-rich-path-style 'abbrev)
 ...
 #+END_SRC
*** ivy-xref
[[https://github.com/alexmurray/ivy-xref/tree/1a35fc0f070388701b05b0a455cbe262e924d547][Link]]
...
(use-package ivy-xref
 ...
 #+END_SRC
*** smex
[[https://github.com/nonsequitur/smex][Link]]
...
(use-package counsel
 ...
 #+END_SRC
*** swiper
[[https://github.com/abo-abo/swiper/tree/b528f0f3aaa86a40fdec06bdb06c603ce1418bcb][Link]]
...
(use-package swiper
 ...
 #+END_SRC
*** yasnippet
[[https://github.com/joaotavora/yasnippet/tree/e45e3de357fbd4289fcfa3dd26aaa7be357fb0b8][Link]]
Yet another snippet extension for Emacs.
 ...
 (use-package yasnippet
  ...
  #+END_SRC
*** yasnippet-snippets
[[https://github.com/AndreaCrotti/yasnippet-snippets/tree/15e4b08f7484c049d6b043263c5e09bc73846e32][Link]]
...
#+END_SRC
*** auto-yasnippet
[[https://github.com/abo-abo/auto-yasnippet/tree/624b0d9711222073a2a3f2186e2605eb99fc83c9][Link]]
...
#+END_SRC
*** wgrep
[[https://github.com/mhayashi1120/Emacs-wgrep/tree/379afd89ebd76f63842c8589127d66096a8bb595][Link]]
...
#+END_SRC
*** deadgrep
[[https://github.com/Wilfred/deadgrep/tree/caeb37b8d6ab83f0eba353d6bbb29678190d4419][Link]]
...
#+END_SRC
*** magit
[[https://github.com/magit/magit/tree/0984d77fbdae0fe85b38dd27036318212b9a1e5d][Link]]
...
Emacs integration for gist.github.com
 ...
 #+END_SRC
*** git-timemachine
[[https://gitlab.com/pidu/git-timemachine/tree/b97f93d66cffcd69281346845d3a1e32197eda29][Link]]
...
:commands git-timemachine)
 #+END_SRC
   ...
   #+END_SRC
*** super-save
[[https://github.com/bbatsov/super-save/tree/2a905b8bdfc93bee16e2d62a61c6211bbe009331][Link]]
Auto-save buffers, based on your activity.
 #+BEGIN_SRC emacs-lisp
(use-package super-save)
 #+END_SRC
*** crux
[[https://github.com/bbatsov/crux/tree/308f17d914e2cd79cbc809de66d02b03ceb82859][Link]]
...
:defer 0.1)
 #+END_SRC
*** keyfreq
[[https://github.com/dacap/keyfreq/tree/9c665c8c219d18866403897936427bb408e3d6b9][Link]]
track command frequencies
 ...
 #+END_SRC
*** htmlize
[[https://github.com/hniksic/emacs-htmlize/tree/8db0aa6aab77475a732b7363f0d57bd3933c18fd][Link]]
...
(global-set-key
 ...
 #+END_SRC
*** avy
[[https://github.com/abo-abo/avy/tree/f91ae613a86187c8ca75e86f22e3f5ac9958399c][Link]]
...
(use-package avy
 ...
 #+END_SRC
*** anzu
[[https://github.com/syohex/emacs-anzu/tree/592f8ee6d0b1bc543943b36a30063c2d1aac4b22][Link]]
...
(use-package anzu
 ...
 #+END_SRC
*** ace-window
[[https://github.com/abo-abo/ace-window/tree/138a80cbc4e9ed17d3a085a3687f5223a142a9a3][Link]]
...
:config
 ...
 (global-set-key (kbd "C-x \\") 'ace-swap-window)
  #+END_SRC
*** windmove
[[https://www.emacswiki.org/emacs/WindMove][Link]]
...
:commands (windmove-up windmove-down windmove-left windmove-right))
 #+END_SRC
*** buffer-move
[[https://github.com/lukhas/buffer-move/tree/cb517ecf8409b5fdcda472d7190c6021f0c49751][Link]]
This file is for people wanting to swap buffers without
typing C-x b on each window.
 #+BEGIN_SRC emacs-lisp
(use-package buffer-move)
 #+END_SRC
*** transpose-frame
[[https://github.com/emacsorphanage/transpose-frame/tree/011f420c3496b69fc22d789f64cb8091834feba7][Link]]
...
:commands tranpose-frame)
 #+END_SRC
*** beacon
[[https://github.com/Malabarba/beacon][Link]]
...
*** dired
**** dired-k
 [[https://github.com/syohex/emacs-dired-k][Link]]
...
Hide dotfiles in dired
 ...
 #+END_SRC
**** dired-imenu
[[https://github.com/DamienCassou/dired-imenu/tree/610e21fe0988c85931d34894d3eee2442c79ab0a][Link]]
imenu binding for dired mode
 #+BEGIN_SRC emacs-lisp
(use-package dired-imenu)
 #+END_SRC
**** dired-rsync
[[https://github.com/stsquad/dired-rsync/tree/d7eb558c4efa73d9e1f50709dbd2374041c0f1a9][Link]]
...
(use-package dired-rsync
 ...
 #+END_SRC
**** dired-hack-utils
[[https://github.com/Fuco1/dired-hacks/tree/20631398b1927e2da36ac2dd818001db544e9f30][Link]]
...
**** dired-narrow
[[https://github.com/Fuco1/dired-hacks/tree/20631398b1927e2da36ac2dd818001db544e9f30][Link]]
This package provides live filtering of files in dired buffers
 #+BEGIN_SRC emacs-lisp
...
*** browse-kill-ring
[[https://github.com/browse-kill-ring/browse-kill-ring/tree/8debc43e41d7e51532698331c6f283905890b904][Link]]
...
:commands browse-kill-ring)
 ...
 #+END_SRC
*** markdown-mode
    [[https://github.com/jrblevin/markdown-mode/tree/115f77df9755c6a453f3e5d9623ff885d207ea82][Link]]
...
[[https://github.com/larstvei/ox-gfm/tree/99f93011b069e02b37c9660b8fcb45dab086a07f][Link]]
Github Flavored Markdown Back-End for Org Export Engine
 #+BEGIN_SRC emacs-lisp
(use-package ox-gfm)
 #+END_SRC
*** flycheck
    [[https://github.com/flycheck/flycheck/tree/bd8a93240aee78e90c83a54ab3799ff4d02f9f15][Link]]
...
[[https://github.com/flycheck/flycheck-color-mode-line/tree/cc474804d4e8088a627485faaf4217a5781aec7d][Link]]
...
(use-package flycheck-color-mode-line
 ...
 #+END_SRC
*** expand-region
[[https://github.com/magnars/expand-region.el/tree/1c31447730443d98f90f65dfcb752f347d46ad1b][Link]]
...
(use-package expand-region
 ...
 #+END_SRC
*** smartparens
[[https://github.com/Fuco1/smartparens/tree/046440700f292c90c4a992f959c8d6725aa9a3bc][Link]]
...
:commands smartparens-mode)
 #+END_SRC
*** projectile
[[https://github.com/bbatsov/projectile/tree/fd85829ef2bdb8b2c183ea1b3ccfd50925824d78][Link]]
...
#+END_SRC
*** counsel-projectile
[[https://github.com/ericdanan/counsel-projectile/tree/fb19569c9799e3edac7504d21a5ecf49231e9500][Link]]
...
#+END_SRC
*** ibuffer-projectile
[[https://github.com/purcell/ibuffer-projectile/tree/76496214144687cee0b5139be2e61b1e400cac87][Link]]
...
** Help
*** which-key
[[https://github.com/justbur/emacs-which-key/tree/ba03e7e5bcbe3f7d95be2cfddd71454151bb98c8][Link]]
...
(use-package which-key
  ...
  #+END_SRC
*** discover-my-major
[[https://melpa.org/#/discover-my-major][Link]]
...
(use-package discover-my-major
 ...
 #+END_SRC
** Org
[[https://orgmode.org/guide/][The compact Org-mode Guide: Top]]
...
Org-mode is a powerful system for organizing your complex life with simple plain-text files. It seamlessly integrates all your notes, mindmaps, TODO lists, calendar, day planner, and project schedules into a single system that can be easily searched (e.g. by grep), encrypted (e.g. by GnuPG), backed up and synced (e.g. by Dropbox), imported/exported, and accessed on the go (e.g. on an iPhone or Android smartphone). It can even be used for authoring web pages and documents.
 ...
 (use-package org
   ...
   #+END_SRC
*** org-cliplink
 [[https://github.com/rexim/org-cliplink/tree/82402cae7e118d67de7328417fd018a18f95fac2][Link]]
...
:commands org-cliplink)
  #+END_SRC
*** org-download
 [[https://github.com/abo-abo/org-download/tree/ac72bf8fce3e855da60687027b6b8601cf1de480][Link]]
 ...
 (setq org-image-actual-width 600))
  ...
  #+END_SRC
*** org-journal
 [[https://github.com/bastibe/org-journal/tree/159794a3f5f28eeab8f87a0378d81d0b2d2cb6fc][Link]]
...
(use-package org-journal
  ...
  #+END_SRC
*** toc-org
 [[https://github.com/snosov1/toc-org/tree/2539b4be401d006e2752f6ad3b88e696889a7fc8][Link]]
